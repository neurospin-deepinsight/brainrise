...
cmd = ["sphinxdoc", "-v 2", "-p",  installdir, "-n", "brainrise", "-o", "..",
       "-i", "brainrise"]
...
# Configure gallery
sphinx_gallery_conf = {
    "doc_module": "brainrise",
    "backreferences_dir": os.path.join("brainrise", "gallery"),
    "examples_dirs": os.path.join(os.pardir, "examples"),
    "gallery_dirs": "auto_gallery",
    "reference_url": {"brainrise": None}}
...
project = u"brainrise"
copyright = u"""{0}, brainrise developers <antoine.grigis@cea.fr>""".format(
...
html_title = "brainrise"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "brainrise"
...
# [howto/manual]).
latex_documents = [
    ("index", "brainrise.tex", "brainrise Documentation", """brainrise developers""",
     "manual"),
]
